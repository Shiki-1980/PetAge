...
train_set= RegressionDataset(metadata_file, image_dire, ttxt, preprocess, txtprocess, True)
test_set= RegressionDataset(test_file, test_dir, tbtxt, preprocess, txtprocess, True)
# print(len(train_set))
